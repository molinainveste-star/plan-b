...
export const VideoChart: React.FC<VideoChartProps> = ({ data }) => {
    ...
    return (
        <div className="glass-panel" style={{
            ...
            // Removed manual box-shadow and border to let class handle it
        }}>
                                ...
                                if (active && payload && payload.length) {
                                    ...
                                    return (
                                        <div style={{
                                            ...
                                            <p style={{ fontWeight: 600, marginBottom: "0.5rem", maxWidth: "200px", color: "var(--foreground)" }}>{data.title}</p>
